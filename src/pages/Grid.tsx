...
const items = [
    ...
    { id: 29, name: 'AUG', gun: 29, img: './img/aug.png' },
    ...
    { id: 30, name: 'Sawed Off', gun: 30, img: './img/sawedoff.png' },
    { id: 27, name: 'SG 553', gun: 27, img: './img/sg553.png' },
    { id: 18, name: 'SSG 08', gun: 18, img: './img/ssg08.png' },
    { id: 8, name: 'Tec-9', gun: 8, img: './img/tec-9.png' },
    { id: 31, name: 'UMP-45', gun: 31, img: './img/ump.png' },
